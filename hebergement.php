...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_nom"])) {
  ...
  // Create a new Hebergement object with updated data
  ...
  // Update the accommodation using the controller method
      ...
      <div class="card rounded-3 shadow-sm">
        ...
        <form class="update-form" action="" method="POST" style="display: none;">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="update_nom" name="update_nom" value="<?= $hebergement['nom'] ?>">
            </div>
            <div class="form-group">
                <label for="update_prix">Prix:</label>
                <input type="text" class="form-control" id="update_prix" name="update_prix" value="<?= $hebergement['prix'] ?>">
            </div>
            <div class="form-group">
                <label for="update_ville">Ville:</label>
                <input type="text" class="form-control" id="update_ville" name="update_ville" value="<?= $hebergement['ville'] ?>">
            </div>
            <div class="form-group">
                <label for="update_adresse">Adresse:</label>
                <input type="text" class="form-control" id="update_adresse" name="update_adresse" value="<?= $hebergement['adresse'] ?>">
            </div>
            <div class="form-group">
                <label for="update_id_categorie">Catégorie:</label>
                <select class="form-control" id="update_id_categorie" name="update_id_categorie">
                    <option value="1" <?= ($hebergement['id_categorie'] == 1) ? 'selected' : ''; ?>>Hotel</option>
                    <option value="2" <?= ($hebergement['id_categorie'] == 2) ? 'selected' : ''; ?>>Maison</option>
                    <option value="3" <?= ($hebergement['id_categorie'] == 3) ? 'selected' : ''; ?>>Resort</option>
                    <option value="4" <?= ($hebergement['id_categorie'] == 4) ? 'selected' : ''; ?>>Appartement</option>
                </select>
            </div>
